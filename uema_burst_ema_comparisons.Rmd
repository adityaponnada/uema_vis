...
uema_comm_df <- uema_df[, c("p_id", "wake_period", "sad", "happy", "fatigue", "relax", "tense", "stress", "frust", "nervous", "focus", "control", "routine")]
...
names(bema_df) <- c("p_id", "wake_period", "sad", "happy", "fatigue", "relax", "tense", "stress", "frust", "nervous", "focus", "control", "routine")

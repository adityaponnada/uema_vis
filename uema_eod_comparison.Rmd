...
peak_effects_df <- data.frame(var_list, count_list)

```


## Try simple queries to get the peak effects
peak effects can be

uema fluctuation, accumulation, dissipation --> Extremely or Quite a bit

```{r}

get_ans_freq_table(merged_df, "uema_stress", "eod_stress")

...
ggplot(count_df, aes(x = eod_nerv, y = uema_nervous)) + geom_tile(aes(fill = Freq)) + scale_fill_gradient(name = 'Frequency', low = 'white', high = 'red') + theme(axis.title.y = element_blank())
